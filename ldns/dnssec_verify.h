...
/** 
 * MTL Ladder cache structure
 */
typedef struct ldns_dnssec_mtl_ladder_cache_struct ldns_dnssec_mtl_ladder_cache;
struct ldns_dnssec_mtl_ladder_cache_struct
{
 ...
 */
void ldns_dnssec_mtl_ladder_cache_init(uint32_t cache_size);
/**
 * Frees the global ladder cache
 */
void ldns_dnssec_mtl_ladder_cache_free(void);
/**
 * Insert a ladder into the cache
 *
 * \param[in] max elements in include in the cache (LIFO)
 */
void ldns_dnssec_mtl_ladder_cache_insert(LADDER* ladder);
/**
