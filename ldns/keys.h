...
enum ldns_enum_algorithm
{
        ...
        LDNS_SLH_DSA_MTL_SHA2_128s = PQC_ALGO_SLH_DSA_MTL_SHA2,
#endif
...
#endif
#ifdef PQC_ALGO_ML_DSA
    LDNS_SIGN_ML_DSA_44 = LDNS_ML_DSA_44,
#endif
#ifdef PQC_ALGO_SLH_DSA_SHA2 
    LDNS_SIGN_SLH_DSA_SHA2_128s = LDNS_SLH_DSA_SHA2_128s,
#endif
#ifdef PQC_ALGO_SLH_DSA_SHAKE
    LDNS_SIGN_SLH_DSA_SHAKE_128s = LDNS_SLH_DSA_SHAKE_128s,
#endif        
#ifdef PQC_ALGO_SLH_DSA_MTL_SHA2 
    LDNS_SIGN_SLH_DSA_MTL_SHA2_128s = LDNS_SLH_DSA_MTL_SHA2_128s,
#endif
#ifdef PQC_ALGO_SLH_DSA_MTL_SHAKE
...
#endif
#ifdef PQC_ALGO_SLH_DSA_MTL_SHA2 
    #define PQC_ALGO_SLH_DSA_MTL_SHA2_OID    {0x2B,0xCE,0x0F,0x06,0x0A,0x10}
    #define PQC_ALGO_SLH_DSA_MTL_SHA2_SCHEME "SPHINCS+-SHA2-128s-simple"
#endif
#ifdef PQC_ALGO_SLH_DSA_MTL_SHAKE 
...
/**
 * Frees a key based on the algorithm
 *
 * \param[in] k allocated key that should be freed
 */
void ldns_key_free_frm_algorithm(ldns_key *k); 
